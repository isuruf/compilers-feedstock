...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/compilers-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/compilers-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add c-compiler compilers cxx-compiler fortran-compiler
# for installing globally
pixi global install c-compiler compilers cxx-compiler fortran-compiler
```
...
It is possible to list all of the versions of `c-compiler` available on your platform:
...
```
pixi search c-compiler --channel conda-forge
```
